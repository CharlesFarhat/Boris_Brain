    ...
    namespace ldso {
        ...
        FullSystem::optimizeImmaturePoint(shared_ptr<internal::ImmaturePoint> point, int minObs,
            ...
            for (int i = 0; i < nres; i++) {
                lastEnergy += point->linearizeResidual(Hcalib->mpCH, 1000, residuals[i], lastHdd, lastbd,
                                                       currentIdepth);
...
// applies step to linearization point.
        ...
        std::vector<VecX>
        FullSystem::getNullspaces(std::vector<VecX> &nullspaces_pose, std::vector<VecX> &nullspaces_scale,
